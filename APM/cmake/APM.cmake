	...
	function(require a_APM_projectName)
		...
		if(DEFINED APM_${a_APM_projectName}_DIR)
			...
			if(${l_APM_need_install})
				...
				if(DEFINED l_APM_require_VERSION)
					list(APPEND l_APM_install_package_args VERSION ${l_APM_require_VERSION})
				endif()
				...
				if(${l_APM_need_compile})
					...
					if(DEFINED l_APM_require_VERSION)
						list(APPEND l_APM_compile_package_args VERSION ${l_APM_require_VERSION})
					endif()
					if(DEFINED l_APM_require_COMPONENTS)
		...
		if(DEFINED l_APM_install_dir AND NOT ${l_APM_install_dir} MATCHES "")
			APM_configure_targets(INSTALL_DIR ${l_APM_install_dir} TARGETS ${l_APM_require_TARGETS})
		endif()
	endfunction()
