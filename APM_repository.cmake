if(APM_REPOSITORY_INCLUDE_GUARD)
	...
	function(APM_require_module a_APM_repo a_APM_projectName a_APM_res)
		...
		if("${l_APM_repositoryType}" MATCHES "FOLDER")
			if(EXISTS "${l_APM_repositoryLocation}/APM_${a_APM_projectName}/APM_${a_APM_projectName}.cmake")
				set(${a_APM_res} "${l_APM_repositoryLocation}/APM_${a_APM_projectName}/APM_${a_APM_projectName}.cmake" PARENT_SCOPE)
			endif()
		else()
