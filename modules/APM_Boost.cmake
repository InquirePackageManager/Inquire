...
function(APM_compile_package )
  ...
  if(NOT EXISTS ${l_APM_B2})
    ...
    execute_process(COMMAND ${l_APM_BOOSTRAPER}  --prefix=${l_APM_compile_package_SOURCE_DIR}/install/${APM_COMPILER_ID}
  ...
  APM_message(STATUS "Building Boost ${l_APM_compile_package_VERSION} components with toolset ${l_APM_toolset}...")
	...
	set(l_APM_B2CallString  ${l_APM_B2} install --toolset=${l_APM_toolset} -j1 --layout=versioned --build-type=complete --prefix=${l_APM_compile_package_SOURCE_DIR}/install/${APM_COMPILER_ID})
...
function(APM_install_package)
	...
	if(NOT DEFINED l_APM_install_package_VERSION)
		...
		APM_message(STATUS "Triggering installation of Boost in version ${l_APM_install_package_VERSION}... ")
	endif()
  ...
  if(NOT EXISTS "${l_APM_BoostLocalArchive}")
	...
	APM_compile_package(SOURCE_DIR ${l_APM_BoostLocalDir} COMPONENTS ${l_APM_install_package_COMPONENTS} VERSION ${l_APM_install_package_VERSION})
endfunction()
	...
	if(NOT l_APM_configure_targets_TARGETS)
		...
		foreach(l_APM_TARGET ${l_APM_configure_targets_TARGETS})
			...
			if(DEFINED Boost_LIBRARIES)
				APM_message(STATUS "Linking libraries ${Boost_LIBRARIES} to targets ${l_APM_configure_targets_TARGETS}.")
